=== Chat by Flyzoo ===
Contributors: Flyzoo
Tags: chat, chat buddypress, buddypress, group chat, community chat, live chat, buddypress chat, live support chat, embed chat, chat room, chatroom, ultimate member, chat members, support chat, chat widget, chat plugin, social network, community
...
* **Cloud based**: no server load. Enjoy a fast message delivery without using your server's resources
...
* **Group Chat**: create multiple, full-featured chat rooms with emoticons, moderation, image and video preview, file sharing and much more!
